...
class bittrex(object):
    ...
    def buy_limit(self, market, quantity, rate):
        ...
        :rtype : dict
        """
        return self.api_query('buylimit', {'market': market, 'quantity': quantity, 'rate': rate, 'FillType': 'IOC'})
    ...
    def sell_limit(self, market, quantity, rate):
        ...
        :rtype : dict
        """
        return self.api_query('selllimit', {'market': market, 'quantity': quantity, 'rate': rate, 'FillType': 'ImmediateOrCancel'})
